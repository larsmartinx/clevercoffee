...
// Display
#define OLED_DISPLAY          0       // 0 = deactivated, 1 = SH1106 (e.g. 1.3 "128x64), 2 = SSD1306 (e.g. 0.96" 128x64), 3 = SH1106_126x64_SPI
...
#define FEATURE_SHOTTIMER     0       // 0 = deactivated, 1 = activated
...
#define POWERSWITCH_TYPE      Switch::MOMENTARY          // Switch::TOGGLE or Switch::MOMENTARY (trigger)
#define POWERSWITCH_MODE      Switch::NORMALLY_CLOSED   // Switch::NORMALLY_OPEN or Switch::NORMALLY_CLOSED
...
#define MQTT_TOPIC_PREFIX            "clevercoffee."   // topic will be "<MQTT_TOPIC_PREFIX><HOSTNAME>/<READING>"
#define MQTT_SERVER_IP               "192.168.1.15" // IP-Address of the MQTT Server
#define MQTT_SERVER_PORT             1883              // Port of the specified MQTT Server
#define MQTT_HASSIO_SUPPORT          1                 // Enables the Homeassistant Auto Discovery Feature
